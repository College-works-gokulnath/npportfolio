...
setdata1(pre=>{
   ...
   return  data2.filter(data=>data.name.toLowerCase().includes(value) && data)})
...
<SearchIcon/>
    <TextField id="outlined-basic" label="Search with name" variant="outlined"  onChange={handleChange}/>
    </div>
    </ArticleHeader>
